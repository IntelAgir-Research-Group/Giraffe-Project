 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.CloudProviderTypeImpl#getMany <em>Many</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.CloudProviderTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.CloudProviderTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CloudProviderTypeImpl extends MinimalEObjectImpl.Container implements CloudProviderType
{
  ...
  {
    return MyDslPackage.Literals.CLOUD_PROVIDER_TYPE;
  }
  ...
  public void setMany(String newMany)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CLOUD_PROVIDER_TYPE__MANY, oldMany, many));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CLOUD_PROVIDER_TYPE__NAME, oldName, name));
  }
  ...
  public CloudProvider getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.CLOUD_PROVIDER_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(CloudProvider newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CLOUD_PROVIDER_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.CLOUD_PROVIDER_TYPE__MANY:
        return getMany();
      case MyDslPackage.CLOUD_PROVIDER_TYPE__NAME:
        return getName();
      case MyDslPackage.CLOUD_PROVIDER_TYPE__TYPE:
