 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.DeployAppFeatureImpl#getMany <em>Many</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.DeployAppFeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.DeployAppFeatureImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeployAppFeatureImpl extends MinimalEObjectImpl.Container implements DeployAppFeature
{
  ...
  {
    return MyDslPackage.Literals.DEPLOY_APP_FEATURE;
  }
  ...
  public void setMany(String newMany)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DEPLOY_APP_FEATURE__MANY, oldMany, many));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DEPLOY_APP_FEATURE__NAME, oldName, name));
  }
  ...
  public DeployApp getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.DEPLOY_APP_FEATURE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(DeployApp newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DEPLOY_APP_FEATURE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.DEPLOY_APP_FEATURE__MANY:
        return getMany();
      case MyDslPackage.DEPLOY_APP_FEATURE__NAME:
        return getName();
      case MyDslPackage.DEPLOY_APP_FEATURE__TYPE:
