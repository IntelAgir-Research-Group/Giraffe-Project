 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.MonitorImpl#getRange <em>Range</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.MonitorImpl#getMonitoringType <em>Monitoring Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MonitorImpl extends TypeImpl implements Monitor
{
  ...
  {
    return MyDslPackage.Literals.MONITOR;
  }
  ...
  public EList<MonitorRangeType> getRange()
  {
    if (range == null)
    {
      range = new EObjectContainmentEList<MonitorRangeType>(MonitorRangeType.class, this, MyDslPackage.MONITOR__RANGE);
    }
    return range;
  }
  ...
  public EList<MonitoringType> getMonitoringType()
  {
    ...
    {
      monitoringType = new EObjectContainmentEList<MonitoringType>(MonitoringType.class, this, MyDslPackage.MONITOR__MONITORING_TYPE);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.MONITOR__RANGE:
        return ((InternalEList<?>)getRange()).basicRemove(otherEnd, msgs);
      case MyDslPackage.MONITOR__MONITORING_TYPE:
