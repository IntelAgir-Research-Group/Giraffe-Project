 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.DeployTypeImpl#getRange <em>Range</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeployTypeImpl extends TypeImpl implements DeployType
{
  ...
  {
    return MyDslPackage.Literals.DEPLOY_TYPE;
  }
  ...
  public EList<DeployRangeType> getRange()
  {
    if (range == null)
    {
      range = new EObjectContainmentEList<DeployRangeType>(DeployRangeType.class, this, MyDslPackage.DEPLOY_TYPE__RANGE);
    }
    return range;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.DEPLOY_TYPE__RANGE:
