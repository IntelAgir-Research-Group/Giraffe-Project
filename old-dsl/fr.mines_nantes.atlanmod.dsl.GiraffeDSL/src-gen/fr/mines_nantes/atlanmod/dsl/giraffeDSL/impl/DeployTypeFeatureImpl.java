 ...
 * <ul>
 *   <li>{@link fr.mines_nantes.atlanmod.dsl.giraffeDSL.impl.DeployTypeFeatureImpl#getMany <em>Many</em>}</li>
 *   <li>{@link fr.mines_nantes.atlanmod.dsl.giraffeDSL.impl.DeployTypeFeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.mines_nantes.atlanmod.dsl.giraffeDSL.impl.DeployTypeFeatureImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeployTypeFeatureImpl extends MinimalEObjectImpl.Container implements DeployTypeFeature
{
  ...
  {
    return GiraffeDSLPackage.Literals.DEPLOY_TYPE_FEATURE;
  }
  ...
  public void setMany(String newMany)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__MANY, oldMany, many));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__NAME, oldName, name));
  }
  ...
  public DeployType getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(DeployType newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__MANY:
        return getMany();
      case GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__NAME:
        return getName();
      case GiraffeDSLPackage.DEPLOY_TYPE_FEATURE__TYPE:
